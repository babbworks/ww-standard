...
%% ── Horizontal rules ──────────────────────────────────────────────────────────
% pandoc emits \rule{} for --- horizontal rules — redefine carefully
% We store the original and define a coloured paragraph-level rule
\let\origRule\rule
% Redefine only the two-arg form; optional first arg still works via origRule
\renewcommand{\rule}[2]{\par\vspace{2pt}\noindent{\color{BabbBorder}\origRule[0pt]{#1}{#2}}\par\vspace{2pt}}
