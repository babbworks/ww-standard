...
% Use lrbox to properly wrap \colorbox around an environment
\newsavebox{\ShadedBox}
\newenvironment{Shaded}{%
  ...
  \end{minipage}%
  \end{lrbox}%
  \noindent\colorbox{CodeBg}{\usebox{\ShadedBox}}%
  \par\vspace{4pt}%
}
...
% KOMA-script + pandoc longtable: pandoc sets \LTcaptype to "none" which
% causes KOMA to look for a counter called "none". Define it as a no-op.
\newcounter{none}
...
%% ── Horizontal rules ──────────────────────────────────────────────────────────
% pandoc emits \rule{width}{height} for --- horizontal rules
% We preserve the optional raise argument so KOMA internals still work
\let\origRule\rule
\renewcommand{\rule}[3][0pt]{%
  \ifnum\dimexpr#3\relax>0pt
    \par\vspace{2pt}\noindent{\color{BabbBorder}\origRule[#1]{#2}{#3}}\par\vspace{2pt}%
  \else
    \origRule[#1]{#2}{#3}%
  \fi
}
\newcommand{\HRule}[1]{\par\vspace{2pt}\noindent{\color{BabbBorder}\origRule[0pt]{#1}{0.5pt}}\par\vspace{2pt}}
...
{\color{BabbTeal}\origRule[0pt]{\linewidth}{0.5pt}}\\[2pt]
\tableofcontents
\clearpage
...
%% ── Colophon ──────────────────────────────────────────────────────────────────
\vspace{12pt}
\noindent{\color{BabbBorder}\origRule[0pt]{\linewidth}{0.5pt}}
\vspace{4pt}
