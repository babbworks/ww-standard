%% Babb Works Technical Standard — LaTeX Template
%% Requires: fontspec, geometry, xcolor, fancyhdr, tikz, longtable,
%%           booktabs, tabularx, hyperref, listings, upquote,
%%           colortbl, parskip, microtype, etoolbox
...
\geometry{
  ...
  headheight=16pt, headsep=8mm, footskip=14mm
}

%% ── Colours ───────────────────────────────────────────────────────────────────
\definecolor{BabbNavy}{HTML}{1A2B45}
\definecolor{BabbTeal}{HTML}{007B7F}
\definecolor{BabbLightTeal}{HTML}{D6EEEF}
\definecolor{BabbGray}{HTML}{5A6272}
\definecolor{BabbLightGray}{HTML}{F4F5F7}
\definecolor{BabbBorder}{HTML}{CBD5E1}
\definecolor{BabbRed}{HTML}{C0392B}
\definecolor{CodeBg}{HTML}{F6F8FA}
\definecolor{CodeBorder}{HTML}{DDE1E9}
\definecolor{RowAlt}{HTML}{F0F4F8}
...
%% ── KOMA section fonts ────────────────────────────────────────────────────────
\setkomafont{section}{\sffamily\large\bfseries\color{BabbNavy}}
\setkomafont{subsection}{\sffamily\normalsize\bfseries\color{BabbNavy}}
\setkomafont{subsubsection}{\sffamily\small\bfseries\color{BabbGray}}
\setkomafont{paragraph}{\sffamily\small\bfseries\color{BabbGray}}
\RedeclareSectionCommand[beforeskip=18pt, afterskip=6pt]{section}
\RedeclareSectionCommand[beforeskip=12pt, afterskip=4pt]{subsection}
\RedeclareSectionCommand[beforeskip=8pt, afterskip=3pt]{subsubsection}

%% ── Section rule ──────────────────────────────────────────────────────────────
\makeatletter
\apptocmd{\sectionlinesformat}{%
  \ifstr{#1}{section}{\color{BabbTeal}\rule[-.3ex]{\linewidth}{0.5pt}}{}%
}{}{}
\makeatother

%% ── Headers & Footers ─────────────────────────────────────────────────────────
\clearpairofpagestyles
\ohead{\footnotesize\sffamily\color{BabbGray}v0.1.0 \textbar\ Draft}
\ihead{\footnotesize\sffamily\color{BabbGray}Workwarrior Technical Standard \textbar\ WW-STD-001}
\ofoot{\footnotesize\sffamily\color{BabbGray}Page~\thepage}
\ifoot{\footnotesize\sffamily\color{BabbGray}\textbf{Babb Works} \textbar\ www.babb.tel \textbar\ workwarrior@babb.tel}
\KOMAoptions{headsepline=0.5pt, footsepline=0.5pt}
\addtokomafont{headsepline}{\color{BabbBorder}}
\addtokomafont{footsepline}{\color{BabbBorder}}
...
\hypersetup{
  ...
  urlcolor=BabbTeal,
  citecolor=BabbTeal,
  pdfauthor={Babb Works},
  pdftitle={Workwarrior Technical Standard},
  pdfsubject={WW-STD-001},
...
%% ── Inline code ───────────────────────────────────────────────────────────────
% Override \texttt so inline code has subtle colour
\let\origTexttt\texttt
\renewcommand{\texttt}[1]{{\ttfamily\fontsize{8.5}{10.5}\selectfont\color{BabbNavy}#1}}

%% ── Code blocks (Shaded = pandoc's verbatim environment) ──────────────────────
% pandoc wraps highlighted code in Shaded + Highlighting
\newcommand{\shadedrule}{\color{CodeBorder}\rule[-0.5ex]{\linewidth}{0.5pt}}
...
\newcommand{\AlertTok}[1]{\textcolor{BabbRed}{\textbf{#1}}}
\newcommand{\AnnotationTok}[1]{\textcolor{BabbGray}{\textit{#1}}}
\newcommand{\AttributeTok}[1]{\textcolor{BabbTeal}{#1}}
\newcommand{\BaseNTok}[1]{#1}
\newcommand{\BuiltInTok}[1]{\textcolor{BabbTeal}{#1}}
\newcommand{\CharTok}[1]{#1}
\newcommand{\CommentTok}[1]{\textcolor{BabbGray}{\textit{#1}}}
\newcommand{\CommentVarTok}[1]{\textcolor{BabbGray}{\textit{#1}}}
\newcommand{\ConstantTok}[1]{#1}
\newcommand{\ControlFlowTok}[1]{\textbf{#1}}
\newcommand{\DataTypeTok}[1]{\textcolor{BabbTeal}{#1}}
\newcommand{\DecValTok}[1]{#1}
\newcommand{\DocumentationTok}[1]{\textcolor{BabbGray}{\textit{#1}}}
\newcommand{\ErrorTok}[1]{\textcolor{BabbRed}{#1}}
\newcommand{\ExtensionTok}[1]{#1}
\newcommand{\FloatTok}[1]{#1}
\newcommand{\FunctionTok}[1]{\textcolor{BabbNavy}{#1}}
\newcommand{\ImportTok}[1]{#1}
\newcommand{\InformationTok}[1]{\textcolor{BabbGray}{#1}}
\newcommand{\KeywordTok}[1]{\textbf{#1}}
\newcommand{\NormalTok}[1]{#1}
\newcommand{\OperatorTok}[1]{#1}
\newcommand{\OtherTok}[1]{#1}
\newcommand{\PreprocessorTok}[1]{\textcolor{BabbGray}{#1}}
...
\newcommand{\WarningTok}[1]{\textcolor{BabbRed}{#1}}

% Also define Highlighting environment used by pandoc
\newenvironment{Highlighting}{\ttfamily\fontsize{8.2}{11}\selectfont}{}
...
%% ── Horizontal rules ──────────────────────────────────────────────────────────
% pandoc \rule{}{} — redefine to use our colour
\let\origRule\rule
\renewcommand{\rule}[2]{\par\noindent{\color{BabbBorder}\origRule{#1}{#2}}\par}

%% ── Title page (manual, called from body) ─────────────────────────────────────
\newcommand{\BabbTitlePage}{%
  \thispagestyle{empty}%
  ...
  \vspace*{8mm}%
  {%
    \noindent\sffamily\color{white}%
    \vspace*{2mm}%
    {\fontsize{8.5}{11}\selectfont\color{BabbTeal!70!white}%
      \MakeUppercase{Babb Works}\enspace\textbar\enspace Technical Standard}\\[5mm]%
    {\fontsize{30}{35}\selectfont\bfseries Workwarrior\\[2pt]Technical Standard}\\[4mm]%
    {\fontsize{13}{16}\selectfont\color{BabbTeal!80!white} WW-STD-001}%
  }%
  \vspace{20mm}

  % Metadata box
  \noindent\fcolorbox{BabbBorder}{BabbLightGray}{%
    \begin{minipage}{\linewidth-2\fboxrule-2\fboxsep-2pt}
      \vspace{4pt}
      \footnotesize\sffamily
      \begin{tabular}{@{}ll@{\hspace{14mm}}ll@{}}
        \textbf{\color{BabbGray}Document Number} & WW-STD-001 &
        \textbf{\color{BabbGray}Version}         & 0.1.0 \\[2pt]
        \textbf{\color{BabbGray}Status}          & Draft &
        \textbf{\color{BabbGray}Date}            & 2026-04-29 \\[2pt]
        \textbf{\color{BabbGray}Maintained by}   & Babb Works &
        \textbf{\color{BabbGray}Website}         & www.babb.tel \\[2pt]
        \multicolumn{2}{@{}l}{\textbf{\color{BabbGray}Contact}\hspace{6.5mm}workwarrior@babb.tel} &
        \multicolumn{2}{l}{\textbf{\color{BabbGray}Repository}\hspace{2mm}github.com/babbworks/ww-standard} \\
      \end{tabular}
      \vspace{4pt}
    \end{minipage}%
  }
  ...
  % Abstract box
  \noindent\fcolorbox{BabbTeal}{BabbLightTeal}{%
    \begin{minipage}{\linewidth-2\fboxrule-2\fboxsep-2pt}
      \vspace{5pt}
      \footnotesize\sffamily\color{BabbNavy}
      \textbf{Abstract.}\enspace This document defines the Workwarrior Technical
      Standard — the canonical specification for the Workwarrior shell productivity
      system developed and maintained by Babb Works. It covers architecture, directory
      structure, environment model, service contracts, browser UI, heuristic engine,
      AI integration, GitHub sync engine, UDA system, shell coding standards, and
      install policy. Implementors and contributors should treat this document as
      authoritative.
      \vspace{5pt}
    \end{minipage}%
  }
  ...
  \vspace{6mm}
  {\footnotesize\sffamily\color{BabbGray}
    Copyright \textcopyright~2026 Babb Works. All rights reserved.
    Maintained at \href{https://github.com/babbworks/ww-standard}{github.com/babbworks/ww-standard}.
    Contact: \href{mailto:workwarrior@babb.tel}{workwarrior@babb.tel}.
  }%
  \clearpage
}
...
{\sffamily\bfseries\large\color{BabbNavy}Table of Contents}\\[-2pt]
{\color{BabbTeal}\origRule{\linewidth}{0.5pt}}\\[2pt]
\tableofcontents
\clearpage
...
\subsubsection{Data Flow Summary}\label{data-flow-summary}
...
\subsection{3. Directory Structure}\label{directory-structure}
...
\subsection{4. Environment Variables}\label{environment-variables}
...
\subsection{5. Profile Model}\label{profile-model}
...
\subsubsection{Lifecycle}\label{lifecycle}
...
\subsubsection{Multiple Named Resources}\label{multiple-named-resources}
...
\subsubsection{Profile Groups}\label{profile-groups}
...
\subsubsection{Backup/Restore Policy}\label{backuprestore-policy}
...
\subsection{6. Shell Bootstrap}\label{shell-bootstrap}

\subsubsection{bin/ww-init.sh}\label{binww-init.sh}
...
\subsubsection{Shell Functions Injected}\label{shell-functions-injected}
...
\subsubsection{RC File Management}\label{rc-file-management}
...
\subsection{7. CLI Dispatcher}\label{cli-dispatcher}

\subsubsection{bin/ww}\label{binww}
...
\subsubsection{Allow-Listed Commands}\label{allow-listed-commands}
...
\subsubsection{Security Constraint}\label{security-constraint}
...
\subsection{8. Core Libraries}\label{core-libraries}

\subsubsection{lib/core-utils.sh}\label{libcore-utils.sh}
...
\subsubsection{lib/profile-manager.sh}\label{libprofile-manager.sh}
...
\subsubsection{lib/shell-integration.sh}\label{libshell-integration.sh}
...
\subsubsection{lib/logging.sh}\label{liblogging.sh}
...
\subsubsection{lib/taskwarrior-api.sh}\label{libtaskwarrior-api.sh}
...
\subsubsection{lib/config-utils.sh}\label{libconfig-utils.sh}
...
\subsubsection{lib/config-loader.sh}\label{libconfig-loader.sh}
...
\subsection{9. Service Architecture}\label{service-architecture}
...
\subsubsection{Minimal Service Template}\label{minimal-service-template}
...
\subsubsection{Profile-Level Service
...
\subsubsection{Service Tiers}\label{service-tiers}
...
\subsection{10. Service Registry}\label{service-registry}
...
\subsection{11. Browser UI}\label{browser-ui}
...
\subsubsection{Server Implementation}\label{server-implementation}
...
\subsubsection{Security Model}\label{security-model}
...
\subsubsection{CMD Input Routing}\label{cmd-input-routing}
...
\subsection{12. Heuristic Engine}\label{heuristic-engine}
...
\subsubsection{Rule Structure}\label{rule-structure}
...
\subsubsection{Confidence Levels by Phrasing
...
\subsubsection{Command Domains}\label{command-domains}
...
\subsubsection{Self-Improvement Loop}\label{self-improvement-loop}
...
\subsection{13. AI Integration}\label{ai-integration}
...
\subsubsection{Provider Registry}\label{provider-registry}
...
\subsubsection{Runtime Control}\label{runtime-control}
...
\subsection{14. GitHub Sync Engine}\label{github-sync-engine}

\subsubsection{Two Engines}\label{two-engines}
...
\subsubsection{Bugwarrior}\label{bugwarrior}
...
\subsubsection{ww github-sync}\label{ww-github-sync}
...
\subsubsection{Field Mapping}\label{field-mapping}
...
\subsubsection{Sync Engine Files}\label{sync-engine-files}
...
\subsubsection{Orphan Detection}\label{orphan-detection}
...
\subsubsection{Annotation/Comment Sync}\label{annotationcomment-sync}
...
\subsubsection{Oracle Token Pattern}\label{oracle-token-pattern}
...
\subsection{15. Weapons System}\label{weapons-system}
...
\subsubsection{Planned Weapons}\label{planned-weapons}
...
\subsubsection{Weapon Constraints}\label{weapon-constraints}
...
\subsection{16. UDA System}\label{uda-system}
...
\subsubsection{UDA Types}\label{uda-types}
...
\subsubsection{Source Classification}\label{source-classification}
...
\subsubsection{Sync Permissions}\label{sync-permissions}
...
\subsubsection{Urgency Tuning}\label{urgency-tuning}
...
\subsubsection{Density Scoring}\label{density-scoring}
...
\subsection{17. Extensions}\label{extensions}

\subsubsection{TaskWarrior Extensions
...
\subsubsection{Hook Events}\label{hook-events}
...
\subsubsection{TimeWarrior Extensions}\label{timewarrior-extensions}
...
\subsection{18. Questions System}\label{questions-system}
...
\subsubsection{Template Structure}\label{template-structure}
...
\subsection{19. Export System}\label{export-system}
...
\subsection{20. Fragility Register}\label{fragility-register}
...
\subsection{21. Shell Coding Standards}\label{shell-coding-standards}
...
\subsubsection{Function Template}\label{function-template}
...
\subsection{22. Testing}\label{testing}

\subsubsection{BATS Tests}\label{bats-tests}
...
\subsubsection{Python Tests (pytest)}\label{python-tests-pytest}
...
\subsubsection{Test Policy}\label{test-policy}
...
\subsection{23. Install Policy}\label{install-policy}

\subsubsection{Core Toolchain}\label{core-toolchain}
...
\subsubsection{Platform Matrix}\label{platform-matrix}
...
\subsubsection{Install Steps}\label{install-steps}
...
\subsubsection{Optional Extensions}\label{optional-extensions}
...
\subsection{24. Dependency Table}\label{dependency-table}
...
%% ── Colophon ──────────────────────────────────────────────────────────────────
\vspace{12pt}
\noindent{\color{BabbBorder}\origRule{\linewidth}{0.5pt}}
\vspace{4pt}

{\footnotesize\sffamily\color{BabbGray}
\textbf{Workwarrior Technical Standard WW-STD-001 v0.1.0}
\enspace\textbar\enspace Maintained by Babb Works\\
\href{https://www.babb.tel}{www.babb.tel}
\enspace\textbar\enspace
\href{mailto:workwarrior@babb.tel}{workwarrior@babb.tel}
\enspace\textbar\enspace
\href{https://github.com/babbworks/ww-standard}{github.com/babbworks/ww-standard}\\[2pt]
Copyright \textcopyright~2026 Babb Works.
This document is the authoritative specification for the Workwarrior system.
}
