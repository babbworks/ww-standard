...
| `log_success "msg"` | `[[OK]] msg` to stdout | --- |
...
| CMD | Natural language + direct command input | Route indicator (fast)/(settings) |
...
*Workwarrior Technical Standard v0.1.0 --- Babb --- workwarrior@babb.tel*
